...
<div id="profile_div" title="Edit Profile">
	<form method ="post" action="ProfileServlet" name="user_profile" id="profile_form">
		...
		<fieldset>
			...
			<input type="text" name="name" id="profile_name" value="<%=((UserBean)session.getAttribute("current_user")).getUserName()%>" class="text ui-widget-content ui-corner-all" readonly/>
			<label for="profile_email">Email</label>
			<input type="text" name="email" id="profile_email" value="<%=((UserBean)session.getAttribute("current_user")).getEmail()%>" class="text ui-widget-content ui-corner-all"  readonly/>
			<input type="hidden" name="password" id="password"/>
			<label for="profile_pwd1">Password</label>
			<input type="password" name="password" id="profile_pwd1" value="" class="text ui-widget-content ui-corner-all .validateTips" />
			<label for="profile_pwd2">Password&nbsp;-&nbsp;again</label>
			<input type="password" name="password" id="profile_pwd2" value="" class="text ui-widget-content ui-corner-all" />
			<label for="profile_userMobile">Mobile</label>
			<input type="text" name="userMobile" id="profile_userMobile" value="<%=((UserBean)session.getAttribute("current_user")).getMobile()%>" class="text ui-widget-content ui-corner-all" />
			<label for="profile_userHomePhone">Your Home Phone</label>
			<input type="text" name="userHomePhone" id="profile_userHomePhone" value="<%=((UserBean)session.getAttribute("current_user")).getHomePhoneNum()%>" class="text ui-widget-content ui-corner-all" />
			<label for="profile_userNote">Leave a Note here</label>
			<input type="text" name="userNote" id="profile_userNote" value="<%=((UserBean)session.getAttribute("current_user")).getNote()%>" class="text ui-widget-content ui-corner-all" />
			<label for="profile_userQQ">Your QQ</label>
			<input type="text" name="userQQ" id="profile_userQQ" value="<%=((UserBean)session.getAttribute("current_user")).getQQ()%>" class="text ui-widget-content ui-corner-all" />
			<label for="profile_userSelfDescription">Leave self description for your friends:</label>
			<input type="text" name="userSelfDescription" id="profile_userSelfDescription" value="<%=((UserBean)session.getAttribute("current_user")).getSelfIntroduction()%>" class="text ui-widget-content ui-corner-all" />
			<%}%>
			<input type="hidden" name="password" id="profile_pwd" class="text ui-widget-content ui-corner-all" />
		</fieldset>
	</form>
</div>
	...
	* Fields are required
	<form method ="post" action="SignInOutServlet" name="user_sign_in" id="sign_in_form">
		...
		<fieldset>
			...
			<input type="text" name="email" id="sign_in_mail" class="text ui-widget-content ui-corner-all" />
